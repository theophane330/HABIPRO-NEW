# urls.py (dans ton app principale, ex: api/urls.py)
...
from .views import (
    ...
    ContractViewSet,
    PaymentViewSet,
    JuridicalDocumentViewSet,           # NOUVEAU
    RegisterView,
    LoginView,
    LogoutView,
    UserProfileView,
...
router.register(r'juridical-documents', JuridicalDocumentViewSet, basename='juridicaldocument')  # CORRIGÉ
...
urlpatterns = [
    ...
    path('', include(router.urls)),  # → http://localhost:8000/
